  ...
  _createClass(SimpleRow, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$RowComponent = _props.RowComponent,
          RowComponent = _props$RowComponent === undefined ? 'tr' : _props$RowComponent,
          rest = _objectWithoutProperties(_props, ['className', 'style', 'attrs', 'visibleColumnSize', 'tabIndexCell', 'RowComponent']);
      ...
      return _react2.default.createElement(
        RowComponent,
        _extends({ style: style, className: className }, trAttrs, { index: typeof RowComponent !== 'string' ? this.props.rowIndex : undefined }),
